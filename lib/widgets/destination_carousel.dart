...
import 'package:flutter_api_project/ui/destination.dart';
...
class _DestinationCarouselState extends State<DestinationCarousel> {
  StreamController<List<Destination>> _dataController;
  ...
  void initState() {
    ...
    Timer.periodic(Duration(seconds: 1), (_) {
      API().fetchDestination().then((value) => _dataController.add(value));
    });
  }
